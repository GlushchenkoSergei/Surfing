        ...
        GeometryReader { geometry in
            ...
            Path { path in
                ...
                path.addQuadCurve(to: CGPoint(x: middle * 1.4, y: middle * 1.2),
                                  control: CGPoint(x: middle * 0.99, y: middle))
                
                path.addQuadCurve(to: CGPoint(x: middle * 0.9, y: middle * 1.5),
                                  control: CGPoint(x: middle, y: middle))
                
                path.addQuadCurve(to: CGPoint(x: middle * 1.7, y: middle),
                                  control: CGPoint(x: middle * 1.1, y: middle))
                
                path.addQuadCurve(to: CGPoint(x: middle, y: middle * 1.5),
                                  control: CGPoint(x: middle * 1.1, y: middle))
