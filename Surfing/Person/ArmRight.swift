    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ...
            Path { path in
                ...
                path.addQuadCurve(to: CGPoint(x: middle*1.31, y: middle*1.00),
                                  control: CGPoint(x: middle*1.345, y: middle*0.999))
            ...
            Path { path in
                path.move(to: CGPoint(x: middle*1.04 , y: min*1.6))
                path.addQuadCurve(to: CGPoint(x: middle*1.09, y: min*2),
                                  control: CGPoint(x: middle*1.08, y: min*1.5))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.1, y: min*2.7),
                                  control: CGPoint(x: middle*1.09, y: min*2.1))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.13, y: middle*0.6),
                                  control: CGPoint(x: middle*1.1, y: min*2.7))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.16, y: middle*0.7),
                                  control: CGPoint(x: middle*1.16, y: min*3.3))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.25, y: middle*0.89),
                                  control: CGPoint(x: middle*1.2, y: middle*0.78))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.14, y: middle*0.7),
                                  control: CGPoint(x: middle*1.2, y: middle*0.78))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.11, y: middle*0.6),
                                  control: CGPoint(x: middle*1.15, y: min*3.3))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.08, y: min*2.7),
                                  control: CGPoint(x: middle*1.09, y: min*2.7))
                
                path.addQuadCurve(to: CGPoint(x: middle*1.04, y: min*1.6),
                                  control: CGPoint(x: middle*1.08, y: min*1.5))
